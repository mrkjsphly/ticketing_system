...
<div class="dashboard-grid priority-grid">
    <div class="card">
        <h4>Critical</h4>
        <div class="card-number" style="color: #ff4d4f;"><?= $critical_priority ?></div>
    </div>
    <div class="card">
        <h4>High</h4>
        <div class="card-number" style="color: #d93025;"><?= $high_priority ?></div>
    </div>
    <div class="card">
        <h4>Medium</h4>
        <div class="card-number" style="color: #c77700;"><?= $medium_priority ?></div>
    </div>
    <div class="card">
        <h4>Low</h4>
        <div class="card-number" style="color: #2b5fd9;"><?= $low_priority ?></div>
    </div>
</div>
