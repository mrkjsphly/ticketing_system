...
$route['tickets/close_ticket/(:num)'] = 'tickets/close_ticket/$1';
$route['admin/activity_logs']                    = 'admin/activity_logs/index';
$route['admin/activity_logs/user_logs']          = 'admin/activity_logs/user_logs';
$route['admin/activity_logs/delete/(:num)']      = 'admin/activity_logs/delete/$1';
$route['admin/activity_logs/delete_user_log/(:num)'] = 'admin/activity_logs/delete_user_log/$1';
$route['admin/activity_logs/clear_all']          = 'admin/activity_logs/clear_all';
$route['admin/user']              = 'admin/user/index';
$route['admin/user/store']        = 'admin/user/store';
$route['admin/user/update/(:num)'] = 'admin/user/update/$1';
$route['admin/user/toggle/(:num)'] = 'admin/user/toggle/$1';
$route['admin/teams']             = 'admin/teams/index';
$route['tech/return_ticket/(:num)'] = 'tech/return_ticket/$1';
$route['tech/store'] = 'tech/store';